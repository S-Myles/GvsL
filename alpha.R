...
S12_richness <- estimate_richness(S12_deep_data, measures = "Chao1")
S12_richness <- as_tibble(sample_data(S12_deep_data), rownames = "SampleID") %>% 
...
##########
# Estimate Richness and find mean
S16_richness <- estimate_richness(S16_deep_data, measures = "Chao1")
S16_richness <- as_tibble(sample_data(S16_deep_data), rownames = "SampleID") %>% 
...
##########
# Estimate Richness and find mean
S18_richness <- estimate_richness(S18_deep_data, measures = "Chao1")
S18_richness <- as_tibble(sample_data(S18_deep_data), rownames = "SampleID") %>% 
...
##########
# Estimate Richness and find mean
COI_richness <- estimate_richness(COI_deep_data, measures = "Chao1")
COI_richness <- as_tibble(sample_data(COI_deep_data), rownames = "SampleID") %>% 
